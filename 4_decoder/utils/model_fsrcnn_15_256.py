...
class Pix2pix256(nn.Module):
    def __init__(self, nef=32, out_channels=3, in_channels = 3, useNorm='NN'):
        ...
        self.rcb1 = RCBBlock(nef*4, nef*4, useNorm=useNorm)
        # 64*64*128-->32*32*256
        self.rcb2 = RCBBlock(nef*4, nef*4, useNorm=useNorm)
        # 32*32*256-->16*16*512
        self.rcb3 = RCBBlock(nef*4, nef*4, useNorm=useNorm)
        # 16*16*512-->8*8*512
        self.rcb4 = RCBBlock(nef*4, nef*4, useNorm=useNorm)
        # 8*8*512-->4*4*512
        self.rcb5 = RCBBlock(nef*4, nef*4, useNorm=useNorm)
        # 4*4*512-->2*2*512
        self.rcb6 = RCBBlock(nef*4, nef*4, useNorm=useNorm)
        self.rcb7 = RCBBlock(nef * 4, nef * 4, useNorm=useNorm)
        self.rcb8 = RCBBlock(nef * 4, nef * 4, useNorm=useNorm)
        self.rcb9 = RCBBlock(nef * 4, nef * 4, useNorm=useNorm)
        self.rcb10 = RCBBlock(nef * 4, nef * 4, useNorm=useNorm)
        self.rcb11 = RCBBlock(nef * 4, nef * 4, useNorm=useNorm)
        self.rcb12 = RCBBlock(nef * 4, nef * 4, useNorm=useNorm)
        # 2*2*512-->1*1*512
        self.relu = LeakyReLU(0.2)
    ...
    def forward(self, x):
        ...
        return self.dconv1(self.pad3(F.relu(x13)))
