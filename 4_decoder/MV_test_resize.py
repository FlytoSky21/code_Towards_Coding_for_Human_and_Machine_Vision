...
root_path = './dataset/1117testdata/resize_img'
save_path = './dataset/1117testdata/resize_img_output'
...
netG.load_state_dict(torch.load('./dataset/models/resize_256/ICME-VGG-netG-MV.ckpt'))
...
print('cost time is : {:.3f}'.format(all_cost_time))
