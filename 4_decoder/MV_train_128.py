...
# dataset
dataroot_128 = 'D:/VGGFace2/tt/128/'


dataroot_256 = 'D:/VGGFace2/tt/256/'
...
for iii in range(roundt,2):
    for epoch in range(epoch_s,epoches):
        ...
        torch.save(netG.state_dict(), './1108data/models/MV_128/round_{:d}_ICME-VGG-netG-MV_{:d}.ckpt'.format(iii, epoch))
        torch.save(netD.state_dict(), './1108data/models/MV_128/round_{:d}_ICME-VGG-netD-MV_{:d}.ckpt'.format(iii, epoch))
        epoch_s = 0
